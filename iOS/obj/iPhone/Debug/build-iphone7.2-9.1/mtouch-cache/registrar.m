...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "get_Window");
	}

	-(void) setWindow:(UIWindow *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "set_Window");
	}

	-(BOOL) application:(UIApplication *)p0 didFinishLaunchingWithOptions:(NSDictionary *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "OnActivated");
	}

	-(void) applicationWillTerminate:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", "WillTerminate");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "StupidStupidTest.iOS.ViewController, StupidStupidTest.iOS", "get_Button");
	}

	-(void) setButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "StupidStupidTest.iOS.ViewController, StupidStupidTest.iOS", "set_Button");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "StupidStupidTest.iOS.ViewController, StupidStupidTest.iOS", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "StupidStupidTest.iOS.ViewController, StupidStupidTest.iOS", "DidReceiveMemoryWarning");
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib", "StupidStupidTest.iOS.ViewController, StupidStupidTest.iOS", "ViewWillAppear");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "StupidStupidTest.iOS.AppDelegate, StupidStupidTest.iOS", NULL },
		{"ViewController", "StupidStupidTest.iOS.ViewController, StupidStupidTest.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [42].handle = [JWAdBreak class];
	__xamarin_class_map [43].handle = [JWAdConfig class];
	__xamarin_class_map [44].handle = [JWCaptionStyling class];
	__xamarin_class_map [45].handle = [JWCastController class];
	__xamarin_class_map [46].handle = [JWCastingDevice class];
	__xamarin_class_map [47].handle = [JWConfig class];
	__xamarin_class_map [48].handle = [JWPlayerController class];
	__xamarin_class_map [49].handle = [JWPlaylistItem class];
	__xamarin_class_map [50].handle = [JWRelatedConfig class];
	__xamarin_class_map [51].handle = [JWSource class];
	__xamarin_class_map [52].handle = [JWTrack class];
